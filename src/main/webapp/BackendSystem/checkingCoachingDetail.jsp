            ...
            <div class="row vh-100">
                ...
                <div class="col-10 p-0">
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-8">
                                <ul class="list-unstyled ms-3">
                                    ...
                                    <li>
                                        ...
                                        <span>
                                         <c:choose>
							              <c:when test="${CoachBean.checked == 0}">待審核</c:when> 
                       ...
                       <form method="post" action="<c:url value='/Member/checkingCoachDetal' />">
	                        <div class="d-flex justify-content-center mb-5">
		                        <input type="hidden" name="coachId" value="${CoachBean.id}">
