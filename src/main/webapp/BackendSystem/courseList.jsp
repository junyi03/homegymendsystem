                  ...
                  <div class="container-fluid p-0">
                    <div class="mb-5">
                        <ul class="nav nav-tabs border-0 border-bottom">
                   			<li  class="nav-item ">
                                <a class="nav-link active fw-bold " href="<c:url value='/Course/checkedCoursePage'/>">已審核課程</a>
                            </li >
                            <li class="nav nav-tabs border-0">
                                <a class="nav-link text-dark" href="<c:url value='/Course/notCheckCoursePage' />">未審核課程</a>
                            </li>
                        </ul>
                        <!-- 查詢列 -->
                            ...
                            <div class="col mb-4">
                                <div class="d-flex">
                                  ...
                                  <select class="form-select  ms-3 me-2" aria-label="Default select example" name="status">
                                    <option selected  value="2">請選擇審核狀態</option>
                            ...
                            <div class="col mb-4">
                                <div class="d-flex">
                                  ...
                                  <select class="form-select ms-3 me-2" aria-label="Default select example" name="partOfBody">
                                   <option selected value="0">請選擇課程分類</option>
