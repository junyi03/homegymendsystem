...
@WebServlet("/Member/CoachListPage")
public class CheckingCoachListPageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/BackendSystem/checkingCoachingList.jsp").forward(request, response);
		return;
	}
